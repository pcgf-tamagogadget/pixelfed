...
@section('section')
	...
	<form method="post">
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="name" name="name" placeholder="{{__('settings.addName')}}" maxlength="30" value="{{Auth::user()->profile->name}}" v-pre>
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<textarea
					...
					id="bio"
					name="bio"
					placeholder="{{__('settings.addBio')}}"
					rows="2"
